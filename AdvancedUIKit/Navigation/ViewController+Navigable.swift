...
public extension UIViewController {
    ...
    public func back(withAnimation shouldAnimate: Bool = true, completion: @escaping () -> Void = {}) {
        guard let navigationController = navigationController else {
    ...
    public func setupBackButton(withBackTitle backTitle: String? = nil, withCancelTitle cancelTitle: String? = nil) {
