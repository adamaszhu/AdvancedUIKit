...
//    
    ...
    public override func drawRect(rect: CGRect) {
        ...
        isInitialized = true
        pageControl.frame = CGRectMake((rect.size.width - pageControl.frame.size.width) / 2, rect.size.height - pageControl.frame.size.height - 20, pageControl.frame.size.width, pageControl.frame.size.height)
    }
